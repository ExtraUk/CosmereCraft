...
public class TinParticle extends TextureSheetParticle {
    private final PositionSource target;
    private float yRot;
    private float yRotO;

    public TinParticle(ClientLevel pLevel, double pX, double pY, double pZ, PositionSource pTarget, int pLifetime, SoundSource soundSource) {
    ...
    @OnlyIn(Dist.CLIENT)
    public static class Provider implements ParticleProvider<TinParticleOption> {
        ...
        public Particle createParticle(TinParticleOption pType, ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            TinParticle tinParticle = new TinParticle(pLevel, pX, pY, pZ, pType.getDestination(), pType.getArrivalInTicks(), pType.getSource());
            tinParticle.pickSprite(this.sprite);
            tinParticle.setAlpha(1.0F);
            return tinParticle;
        }
    }
}
